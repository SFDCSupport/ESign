            ...
            <form id="signersForm">
                <main class="lg:pr-96">
                    <header
                        ...
                        <label class="text-white"><input type="file" id="document" name="document"/></label>
                    </header>
                ...
                <aside
                    ...
                    <header
                        ...
                        <div class="flex flex-row gap-4">
                            <button type="button" id="addSigner" class="bg-white border border-white px-4 rounded">Add
                                Signer
                            </button>
                            <button type="button" id="saveButton" class="bg-white border border-white px-4 rounded">
                                Save
                            </button>
                        </div>
                    </header>
